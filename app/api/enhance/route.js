...
export async function POST(req) {
  try {
    ...
    const stylePrompts = {
      ...
      satellite: "shaded relief map, raised relief cartography, hypsometric tinting, dramatic hillshade with deep shadows, embossed 3D terrain, green lowlands transitioning to brown highlands to white snow peaks, fine ridge and valley detail, matte finish topographic map, physical geography map, soft cream colored ocean, no labels, no text, cartographic art print, museum quality relief map",
